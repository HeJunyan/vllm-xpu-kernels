...
# 
# Arguments:
#   LIBRARY_NAME: Name of the library to create (e.g., attn_kernels_xe_3)
...
function(add_xe3_kernel_library LIBRARY_NAME)
  ...
  list(APPEND XE3_GPU_LINK_FLAGS -Xsycl-target-backend=spir64_gen "-device ${XE3_AOT_DEVICES} -internal_options -cl-intel-256-GRF-per-thread")
  target_link_options(${LIBRARY_NAME} PRIVATE ${XE3_GPU_LINK_FLAGS})
endfunction()


#
# Create a shared library for XE4 kernels with common configuration.
# 
# Arguments:
#   LIBRARY_NAME: Name of the library to create (e.g., attn_kernels_xe_4)
#   DESTINATION: Installation destination directory (optional, defaults to vllm_xpu_kernels)
#   INCLUDE_CMAKE_SOURCE_DIR: Optional flag to include ${CMAKE_SOURCE_DIR} in include directories
#
function(add_xe4_kernel_library LIBRARY_NAME)
  cmake_parse_arguments(
    PARSE_ARGV 1
    ARG
    "INCLUDE_CMAKE_SOURCE_DIR"  # Boolean options
