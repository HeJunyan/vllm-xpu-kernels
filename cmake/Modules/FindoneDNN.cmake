...
if(NOT ONEDNN_FOUND)
  ...
  if(DEFINED ENV{VLLM_ONEDNN_SRC_DIR})
    set(VLLM_ONEDNN_SRC_DIR $ENV{VLLM_ONEDNN_SRC_DIR})
  endif()

  if(VLLM_ONEDNN_SRC_DIR)
    if(NOT IS_ABSOLUTE VLLM_ONEDNN_SRC_DIR)
      get_filename_component(VLLM_ONEDNN_SRC_DIR "${VLLM_ONEDNN_SRC_DIR}"
                             ABSOLUTE)
    endif()
    message(
      STATUS
        "VLLM_ONEDNN_SRC_DIR is set, using ${VLLM_ONEDNN_SRC_DIR} for oneDNN")
    FetchContent_Declare(oneDNN SOURCE_DIR ${VLLM_ONEDNN_SRC_DIR})
  else()
    message(
      STATUS
