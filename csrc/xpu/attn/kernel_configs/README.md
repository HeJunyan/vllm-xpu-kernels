...
| `chunk_prefill_default.conf` | 13 | Chunk prefill — Llama, Qwen, DeepSeek MLA (+ full fp8, sliding-window/sink) |
| `paged_decode_full.conf` | 384 | Paged decode — all combinations |
| `paged_decode_default.conf` | 17 | Paged decode — Llama, Qwen, DeepSeek MLA (+ full fp8, sliding-window/sink) |
