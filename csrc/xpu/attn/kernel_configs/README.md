...
| `chunk_prefill_default.conf` | ~17 | Chunk prefill — Llama, Qwen, DeepSeek MLA, Falcon (+ full fp8, sliding-window/sink) |
| `paged_decode_full.conf` | 384 | Paged decode — all combinations |
| `paged_decode_default.conf` | ~23 | Paged decode — Llama, Qwen, DeepSeek MLA, Falcon (+ full fp8, sliding-window/sink) |
